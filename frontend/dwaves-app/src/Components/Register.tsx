    ...
    return (
        <div className="flex flex-col justify-center">
            ...
            <div id="input-text" className="form-control w-full">
                ...
                <input type="text" {...register('email')} placeholder="Type here" className="input input-ghost" />
            </div>
            <div id="input-text" className="form-control w-full">
                <label className="label">
            ...
            <div id="input-text" className="form-control w-full">
                ...
                <input type="text" {...register('password')} placeholder="Type here" className="input input-ghost" />
            </div>
            <button type="submit" className="btn btn-primary m-8">Register</button>
        </div>
    )
}