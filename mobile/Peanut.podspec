...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "sofian" => "sofiansalh2305@gmil.com" }
  # Or just: spec.author    = "sofian"
  # spec.authors            = { "sofian" => "sofiansalh2305@gmil.com" }
  # spec.social_media_url   = "https://twitter.com/sofian"
